...
class Select_FIB:
    ...
    def fill_fib(self, question5):
        self.wait.until(expected_conditions.presence_of_element_located((By.XPATH, "//span[@role='toolbar']")))
        self.driver.switch_to.frame(0)
        self.driver.find_element(*Select_FIB.question_text).send_keys(question5)
        self.driver.switch_to.default_content()
        self.driver.find_element(*Select_FIB.add_weight).clear()
        self.driver.find_element(*Select_FIB.add_weight).send_keys(15)
        self.driver.find_element(*Select_FIB.learning_obj).send_keys("By the end of period_of_time everything will be automated")
        self.driver.find_element(*Select_FIB.rationale).send_keys("Connecting Learning goals")
        self.driver.find_element(*Select_FIB.difficulty_level).click()
        self.driver.find_element(*Select_FIB.difficulty_value_high).click()
        self.driver.find_element(*Select_FIB.question_visibility).click()
        self.driver.find_element(*Select_FIB.question_option_institution).click()
        return self.driver.find_element(*Select_FIB.save_question_button).click()
