...
class Select_Voice:
    ...
    def fill_voice(self, question6):
        self.wait.until(expected_conditions.presence_of_element_located((By.XPATH, "//span[@role='toolbar']")))
        self.driver.switch_to.frame(0)
        self.driver.find_element(*Select_Voice.question_text).send_keys(question6)
        self.driver.switch_to.default_content()
        self.driver.find_element(*Select_Voice.add_weight).clear()
        self.driver.find_element(*Select_Voice.add_weight).send_keys(15)
        self.driver.find_element(*Select_Voice.learning_obj).send_keys("By the end of period_of_time everything will be automated")
        self.driver.find_element(*Select_Voice.rationale).send_keys("Connecting Learning goals")
        self.driver.find_element(*Select_Voice.difficulty_level).click()
        self.driver.find_element(*Select_Voice.difficulty_value_high).click()
        self.driver.find_element(*Select_Voice.question_visibility).click()
        self.driver.find_element(*Select_Voice.question_option_institution).click()
        return self.driver.find_element(*Select_Voice.save_question_button).click()