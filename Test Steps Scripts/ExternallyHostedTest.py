...
driver.find_element(By.XPATH,"//textarea[@class='form-control']").send_keys("Test Automation Dummy External 01")
driver.find_element(By.XPATH,"//textarea[@name='description']").send_keys("Description for Test Automation Dummy for externally hosted Exam")
...
#Externally Hosted Test
external = driver.find_element(By.XPATH,"//input[@name='is_hosted_externally']")
external.click()
assert external.is_selected(), "Not Externally Hosted"
driver.find_element(By.XPATH,"//input[@id='id_test_callback_url']").send_keys("https://www.geeksforgeeks.org/python-programming-language-tutorial/")
